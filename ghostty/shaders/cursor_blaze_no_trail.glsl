...
const vec4 TRAIL_COLOR = vec4(0.557, 0.753, 0.486, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.984, 0.945, 0.78, 1.0);
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.722, 0.733, 0.149, 1.0);
